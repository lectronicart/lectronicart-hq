...
{p:2,theme:"Graduation Week — finish Odin JS · Plan Mode unlocked",days:[
 {t:"Odin: Objects + Etch-a-Sketch",d:["Odin: Fundamentals Part 5 (objects, object methods).","Finish Etch-a-Sketch."],g:["ODIN"],h:"2.5 hrs",lesson:{essence:"Odin's final JavaScript fundamentals layer: objects, properties, methods, and finishing Etch-a-Sketch as a DOM-driven creative tool",bullets:["Use objects to group related values and functions so data has shape instead of floating loose.","Practice reading, changing, and calling object properties and methods in plain JavaScript.","Finish Etch-a-Sketch by connecting grid state, pointer behavior, and DOM updates into one working interaction."]}},
 {t:"Odin Project: Calculator (day 1)",d:["The Foundations boss fight. Build the UI and basic operations. Still no AI-written code — this is your final solo project."],g:["ODIN","BUILD"],h:"2.5 hrs",lesson:{essence:"Odin Calculator day 1: designing the interface, wiring number/operator buttons, and making basic arithmetic work without AI-written code",bullets:["Build the calculator layout so the display, digits, operators, clear button, and equals button have clear roles.","Write the first event handlers that turn button clicks into stored numbers and chosen operations.","Keep the project solo today so the Foundations concepts prove they are in your hands, not only in the chat."]}},
 {t:"Odin Calculator (day 2) — Foundations done!",d:["Finish the calculator: chained operations, decimal, clear, edge cases (divide by zero!).","Odin Foundations: complete. Screenshot it. You've finished what most people quit."],g:["ODIN","BUILD"],h:"2.5 hrs",lesson:{essence:"Odin Calculator finish: chained operations, decimal behavior, clear/reset flow, divide-by-zero handling, and a complete Foundations artifact",bullets:["Finish the operation flow so repeated calculations, equals, and chained operators behave predictably.","Handle decimals, clearing, display updates, and divide-by-zero as user-facing edge cases.","Capture the finished project as proof that you can design, build, debug, and complete a real browser tool."]}},
 {t:"AI assistance unlocked: Plan Mode",d:["Full Stack Open Part 0 (a+b): Fundamentals of Web Apps.","First official Plan Mode session in Codex. Practice: plan a tiny feature, review the plan, approve, read every line of the diff."],g:["FSO","CODEX"],h:"2.5 hrs",l:[["FSO Part 0",FSO+"part0"],["Codex best practices",CODEX_BEST]],lesson:{essence:"the Phase 2 handoff: Full Stack Open's web-app request model plus Codex Plan Mode as a reviewed design-and-diff workflow",bullets:["Learn how browsers, servers, HTTP requests, forms, and JavaScript fit together in modern web apps.","Use Plan Mode to describe a tiny change, review the proposed approach, and approve only what you understand.","Read every generated diff line as a learning rep before accepting AI-assisted code."]}},
 {t:"Level up your Codex workflow",d:["Read the Codex best-practices guide and the AGENTS.md guide.","Set up a fresh project with your tutor AGENTS.md. New rule for Phase 2: read every line before accepting, and ask 'teach me' questions, not 'do it' questions."],g:["CODEX"],h:"2 hrs",l:[["Codex best practices",CODEX_BEST],["AGENTS.md guide",CODEX_AGENTS]],lesson:{essence:"Codex workflow foundations: clear task context, repo instructions, AGENTS.md guidance, small diffs, and teach-me review habits",bullets:["Give Codex enough project context, constraints, and success criteria before asking for implementation help.","Use AGENTS.md as the repo's working agreement so future sessions remember the rules of the project.","Ask for explanations and review small diffs line by line instead of treating generated code as magic."]}},
 {t:"Build #5: habit tracker",d:["Design a habit tracker with streak logic yourself (sketch the data shape first).","Let Codex draft ONE function in Plan Mode. Review every line. Then delete it and rebuild it from scratch — the explain-then-rebuild loop."],g:["BUILD","CODEX"],h:"3 hrs",lesson:{essence:"the first Phase 2 AI-assisted build: a habit tracker data model, streak rules, one reviewed Codex function, and a rebuild from understanding",bullets:["Sketch habits, check-ins, dates, streak counts, and reset rules before writing code.","Let Codex draft one focused function, then inspect every variable, branch, and return value.","Delete the drafted function and rebuild it yourself so AI becomes a teacher, not a crutch."]}},
 REST()
]},
{p:2,theme:"React Begins — Full Stack Open Part 1",days:[
 {t:"FSO 1a — Introduction to React",d:["Work through 1a + exercises. Components and JSX will feel weird for ~3 days. That's normal."],g:["FSO"],h:"2.5 hrs",l:[["FSO Part 1",FSO+"part1"]],lesson:{essence:"Full Stack Open's first React layer: Vite, components, JSX, props, dynamic content, component composition, and browser console habits",bullets:["Create and run a React app so the development server, source files, and browser update loop make sense.","Read JSX as JavaScript-flavored UI and split the page into small named components.","Pass data into components with props and inspect behavior through the browser console."]}},
 {t:"FSO 1b — JavaScript refresher",d:["Work through 1b. This should mostly feel familiar after Odin — note anything that doesn't and drill it with ChatGPT."],g:["FSO","CODEX"],h:"2 hrs",lesson:{essence:"the JavaScript React depends on: variables, arrays, objects, functions, methods, modules, and component syntax",bullets:["Review modern JavaScript syntax so React examples feel readable instead of mysterious.","Practice arrays, objects, destructuring, functions, and callbacks as the raw material of component logic.","Mark any shaky topic and ask ChatGPT for a small quiz or analogy before moving on."]}},
 {t:"FSO 1c — Component state",d:["Work through 1c: state, event handlers, hooks intro. Do every exercise."],g:["FSO"],h:"2.5 hrs",lesson:{essence:"React's first interactivity layer: component state, event handlers, the useState hook, rerendering, and UI that changes after a click",bullets:["Use state to remember values inside a component between renders.","Write event handlers that update state when a user clicks or interacts with the page.","Connect state changes to visible UI changes so React's rerender loop becomes concrete."]}},
 {t:"FSO 1d — Complex state & debugging",d:["Work through 1d + finish all Part 1 exercises.","Ask ChatGPT: 'Quiz me: 5 questions on React state and props.'"],g:["FSO","CODEX"],h:"2.5 hrs",lesson:{essence:"React's deeper state practice: multiple state values, object/array updates, immutable changes, debugging, and finishing the Part 1 exercises",bullets:["Compare separate state values with object or array state and notice the tradeoffs.","Update state immutably instead of mutating existing objects or arrays in place.","Use console output, React warnings, and small exercises to debug props, state, and render behavior."]}},
 {t:"Weather app: design day",d:["Build #6 begins: weather app using the free Open-Meteo API.","Plan Mode session: sketch the UI, define components, write the plan with Codex — but no code today. Architecture first."],g:["BUILD","CODEX"],h:"2 hrs",lesson:{essence:"weather app architecture: Open-Meteo data needs, location inputs, component boundaries, loading/error states, and a reviewed Plan Mode build plan",bullets:["Sketch the weather app before coding: search/input, current conditions, forecast area, and empty/loading/error states.","Identify the Open-Meteo endpoint, query parameters, and data fields the first version needs.","Use Codex to review the component plan while Derrick owns the design decisions."]}},
 {t:"Weather app: build the core",d:["Write the fetch + current-weather display yourself; Codex reviews your code and suggests improvements (read every suggestion before accepting)."],g:["BUILD"],h:"2.5 hrs",lesson:{essence:"the first React data-fetching build: requesting Open-Meteo weather data, parsing JSON, storing results, and rendering current conditions",bullets:["Write the fetch flow yourself so API request, response, JSON parsing, and state update are understandable.","Render the current-weather values in the UI with labels a real user can read.","Let Codex review the code, then accept only suggestions you can explain line by line."]}},
 REST()
]},
{p:2,theme:"Talking to Servers — Full Stack Open Part 2",days:[
 {t:"FSO 2a — Rendering collections",d:["Work through 2a: rendering lists, modules, key props."],g:["FSO"],h:"2.5 hrs",l:[["FSO Part 2",FSO+"part2"]],lesson:{essence:"Full Stack Open Part 2a: rendering data collections with map, stable keys, modules, component files, and list-focused React exercises",bullets:["Turn arrays of data into visible component lists with map instead of hand-written repeated markup.","Give list items stable keys so React can track what changed between renders.","Move components into modules and pass collection data through props so the app structure stays readable."]}},
 {t:"FSO 2b — Forms",d:["Work through 2b: controlled components, form handling."],g:["FSO"],h:"2.5 hrs",lesson:{essence:"React forms: controlled inputs, submit handlers, filter fields, adding records, and keeping form state synchronized with the UI",bullets:["Store input values in state so the React component controls what the form displays.","Handle submit events without refreshing the page and turn typed values into new records.","Add filtering or search behavior so form state changes what the user sees immediately."]}},
 {t:"FSO 2c — Getting data from server",d:["Work through 2c: axios/fetch, effects, async data. This connects directly to your weather app."],g:["FSO"],h:"2.5 hrs",lesson:{essence:"React server data: axios or fetch, promises, useEffect, JSON responses, local test servers, and loading remote records into state",bullets:["Request data from a server and understand the promise/response/JSON path before it reaches React state.","Use useEffect for data loading that should happen after the component renders.","Separate server data, local state, and rendered UI so async code does not become a blur."]}},
 {t:"FSO 2d — Altering server data",d:["Work through 2d: POST, PUT, DELETE — full CRUD over HTTP."],g:["FSO"],h:"2.5 hrs",lesson:{essence:"CRUD over HTTP: POST, PUT, DELETE, RESTful resource URLs, server updates, local state sync, and user-visible error handling",bullets:["Create, update, and delete records through HTTP requests instead of only changing local memory.","Keep React state synchronized with what the server accepted or rejected.","Start thinking like a product builder by handling duplicate records, failed requests, and user confirmation flows."]}},
 {t:"Weather app: forecast + states",d:["Add a 5-day forecast, plus proper loading and error states (the difference between a demo and a product)."],g:["BUILD"],h:"2.5 hrs",lesson:{essence:"weather app product states: Open-Meteo daily forecast data, five-day display, loading, empty, error, retry, and user-facing resilience",bullets:["Request and render a five-day forecast so the app moves beyond a single current-weather card.","Add loading, empty, and error states so users know what is happening while data is missing or delayed.","Use clear labels and recovery paths so a failed API request feels handled instead of broken."]}},
 {t:"Weather app: ship it",d:["Polish and deploy to Vercel.","Explain-then-rebuild: delete your main data-fetching component and rewrite it from memory."],g:["BUILD","SHIP"],h:"2.5 hrs",lesson:{essence:"the weather app shipping loop: polish the UI, deploy to Vercel, verify the live build, and rebuild the data-fetching component from memory",bullets:["Polish spacing, labels, empty states, and forecast readability before sharing the app.","Deploy the project and verify the live URL loads the same weather flow as local development.","Delete and rebuild the main data-fetching component from memory to prove the pattern is yours."]}},
 REST()
]},
{p:2,theme:"Styling & CRUD — FSO Part 2 done · Notes app",days:[
 {t:"FSO 2e — Styling React apps",d:["Work through 2e and finish all Part 2 exercises."],g:["FSO"],h:"2.5 hrs",lesson:{essence:"Full Stack Open Part 2e: styling React apps, class names, CSS files, inline styles, user messages, and finishing the Part 2 exercises",bullets:["Apply CSS to React components without confusing styling decisions with data or state logic.","Use classes, inline styles, and notification messages to make app feedback visible to the user.","Finish the Part 2 exercises so collections, forms, server data, CRUD, and styling connect in one mental model."]}},
 {t:"Notes app: design day",d:["Build #7: markdown notes app with full CRUD.","Plan Mode: define the data model and component tree with Codex. You design, AI drafts, you review."],g:["BUILD","CODEX"],h:"2 hrs",lesson:{essence:"markdown notes app architecture: note data shape, component tree, CRUD flow, selected note state, preview area, and a reviewed Plan Mode plan",bullets:["Sketch the note model first: id, title, markdown body, timestamps, and any saved status the app needs.","Define components for the editor, notes list, preview, empty state, and action buttons before writing code.","Use Codex to critique the plan while Derrick owns the product shape and keeps the first diff small."]}},
 {t:"Notes app: Create + Read",d:["Build note creation and the notes list. Review every AI-drafted line; rewrite anything you can't explain."],g:["BUILD"],h:"2.5 hrs",lesson:{essence:"the first notes app implementation loop: creating notes, rendering the notes list, selecting a note, and reading state back through the UI",bullets:["Build the add-note flow so user input becomes a new note object in state.","Render the notes list from data and use selection state to show the active note.","Review every generated line and rewrite any create/read logic you cannot explain clearly."]}},
 {t:"Notes app: Update + Delete",d:["Build editing and deletion. Handle the empty state nicely."],g:["BUILD"],h:"2.5 hrs",lesson:{essence:"notes app CRUD completion: editing existing notes, deleting notes, handling empty state, and keeping selected-note state valid",bullets:["Update note title or body by changing the right item in state without mutating the original array directly.","Delete notes and decide what the UI should select or show afterward.","Design the empty state so the app still feels intentional when there are no notes."]}},
 {t:"Notes app: markdown + persistence",d:["Add live markdown preview (marked.js) and localStorage persistence."],g:["BUILD"],h:"2.5 hrs",lesson:{essence:"markdown preview and browser persistence: converting markdown with marked.js, live preview state, localStorage saves, and reload recovery",bullets:["Render markdown as a live preview so editing text immediately changes the reading surface.","Save notes to localStorage and load them back when the browser refreshes.","Keep parsing, persistence, and editing responsibilities separated enough that each part can be debugged."]}},
 {t:"Notes app: polish + checkpoint quiz",d:["Polish and deploy.","Ask ChatGPT: '10 questions across React state, props, effects, and CRUD. Grade me.' Anything below 8/10, schedule a review day."],g:["BUILD","CODEX","SHIP"],h:"2.5 hrs",lesson:{essence:"the notes app shipping checkpoint: polish UI details, deploy the CRUD app, and quiz React state, props, effects, and CRUD weak spots",bullets:["Polish labels, spacing, empty states, and interaction feedback before sharing the app.","Deploy the notes app and confirm create, read, update, delete, preview, and persistence still work live.","Use the checkpoint quiz to find weak React concepts and schedule review instead of pretending they are solved."]}},
 REST()
]},
{p:2,theme:"Your First Backend — Full Stack Open Part 3",days:[
 {t:"FSO 3a — Node.js & Express",d:["Work through 3a: build your first REST API."],g:["FSO"],h:"2.5 hrs",l:[["FSO Part 3",FSO+"part3"]],lesson:{essence:"Full Stack Open Part 3a: Node.js runtime, npm scripts, Express server setup, REST routes, JSON responses, middleware, and API testing",bullets:["Build a backend that answers HTTP requests instead of only rendering UI in the browser.","Use Express routes to define GET, POST, DELETE, and other resource actions for a REST API.","Practice request/response thinking with JSON, status codes, middleware, and tools like the browser or REST client."]}},
 {t:"FSO 3b — Deploying to the internet",d:["Work through 3b: deploy your backend (Fly.io/Render), connect the frontend."],g:["FSO"],h:"2.5 hrs",lesson:{essence:"backend deployment basics: connecting React to Express, CORS, environment ports, production builds, static files, and server logs",bullets:["Connect the frontend service layer to your own backend API instead of a fake JSON server.","Handle CORS, relative URLs, and production build files so frontend and backend can work from one deployed address.","Use host logs and browser network errors to debug deployment problems instead of guessing."]}},
 {t:"FSO 3c — Saving data to MongoDB",d:["Work through 3c: database persistence, Mongoose models."],g:["FSO"],h:"2.5 hrs",lesson:{essence:"database persistence with MongoDB: Atlas setup, connection strings, Mongoose schemas/models, env variables, and debugging server data",bullets:["Move notes from temporary server memory into a database that survives restarts.","Use Mongoose schemas and models to describe the shape of database documents.","Protect database URLs with environment variables and debug failures through logs, requests, and connection state."]}},
 {t:"FSO 3d — Validation & ESLint",d:["Work through 3d and finish Part 3 exercises."],g:["FSO"],h:"2.5 hrs",lesson:{essence:"backend quality controls: Mongoose validation, error-handler middleware, useful HTTP errors, ESLint, and finishing Part 3 exercises",bullets:["Validate incoming data before it is saved so the database does not accept broken records.","Route validation and malformed-id errors through middleware with clear status codes and messages.","Run ESLint so style problems and suspicious JavaScript are caught before deployment."]}},
 {t:"Notes app v2: real backend",d:["Plan Mode: replace localStorage with an Express + database backend. Review the plan hard before approving — this touches 3+ files."],g:["BUILD","CODEX"],h:"2.5 hrs",lesson:{essence:"notes app backend migration: replacing localStorage with Express routes, MongoDB documents, service calls, env variables, and a multi-file review plan",bullets:["Plan the data contract between React and Express before changing files.","Define endpoints, note schema fields, service functions, and environment variables for the backend version.","Review the Plan Mode diff extra carefully because frontend, backend, and database code now depend on each other."]}},
 {t:"Notes app v2: full-stack trace",d:["Finish wiring frontend ↔ backend.","Ask ChatGPT: 'Walk me through what happens when I click Save — trace it from click to database write.' The full-stack mental model, locked in."],g:["BUILD","CODEX"],h:"2.5 hrs",lesson:{essence:"the first full-stack trace: Save click, React state, HTTP request, Express route, validation, MongoDB write, response JSON, and UI update",bullets:["Finish wiring the React app to the Express backend and database-backed notes API.","Trace the Save flow step by step from browser event to database write and back to rendered UI.","Use ChatGPT as an examiner: explain each boundary until the full-stack path is no longer mysterious."]}},
 REST()
]},
{p:2,theme:"Mini-SaaS Sprint — Phase 2 capstone",days:[
 {t:"Pick your clone + spec it",d:["Choose one: URL shortener, link-in-bio page builder, or pomodoro timer with analytics.","Plan Mode: write the full spec and milestone list with Codex. Cut scope twice before starting."],g:["BUILD","CODEX"],h:"2 hrs",lesson:{essence:"Mini-SaaS capstone scoping: choosing one clone, writing a tight spec, defining milestones, and cutting scope before code starts",bullets:["Pick a small product whose core job can be explained in one sentence.","Use Plan Mode to turn the idea into a spec, milestone list, data model, and acceptance criteria.","Cut nice-to-have features twice so the sprint protects learning, shipping, and review quality."]}},
 {t:"Build day 1: core feature",d:["Build the one thing the product does. You design, AI drafts, you review every line."],g:["BUILD"],h:"2.5 hrs",lesson:{essence:"capstone build day one: the single core feature, first usable flow, component boundaries, and line-by-line review of AI-assisted code",bullets:["Build the one action the product exists to perform before adding supporting features.","Keep the data flow and component boundaries simple enough to explain out loud.","Review every AI-drafted line and rewrite any core logic you cannot teach back."]}},
 {t:"Build day 2: persistence + edges",d:["Add data persistence and handle edge cases (bad input, duplicates, empty states)."],g:["BUILD"],h:"2.5 hrs",lesson:{essence:"capstone build day two: persistence, validation, duplicate handling, empty states, bad input, and product behavior when reality gets messy",bullets:["Add persistence so the product remembers user-created data beyond the first interaction.","Handle invalid input, duplicates, missing data, and empty states with intentional feedback.","Test edge cases as part of the product, not as cleanup after the fun work."]}},
 {t:"Build day 3: UI polish",d:["Make it look intentional: spacing, typography, error and loading states."],g:["BUILD"],h:"2.5 hrs",lesson:{essence:"capstone polish day: visual hierarchy, spacing, typography, loading states, error states, responsive checks, and making the tool feel intentional",bullets:["Tighten layout, spacing, labels, typography, and contrast so the product feels designed.","Make loading, error, empty, and success states visible instead of hidden in the console.","Check the main flow on desktop and mobile before calling the build done."]}},
 {t:"Deploy + README",d:["Deploy. Write the README like a product landing page: what it does, who it's for, screenshots."],g:["SHIP"],h:"2 hrs",lesson:{essence:"capstone shipping: deploy the app, verify the live URL, write a product-style README, add screenshots, and explain who it helps",bullets:["Deploy the project and test the same core flow on the live URL, not only on localhost.","Write the README like a tiny landing page: what it does, who it is for, how it works, and what you learned.","Add screenshots or usage notes so a stranger can understand the product without asking you."]}},
 {t:"Phase 2 retro",d:["Ask ChatGPT: 'Quiz me on everything from FSO Parts 0–3.' Identify your 2 weakest topics and book review slots on future Sundays.","Journal: what can you build now that you couldn't 12 weeks ago?"],g:["CODEX"],h:"2 hrs",lesson:{essence:"Phase 2 retro: testing your understanding of FSO Parts 0-3, finding weak topics, scheduling review, and naming what you can now build",bullets:["Use ChatGPT as an examiner across web app fundamentals, React, server data, CRUD, Express, and MongoDB.","Identify the two weakest topics and reserve future Sunday review time instead of rushing past them.","Write the before-and-after: what you can build now that you could not build twelve weeks ago."]}},
...
{p:3,theme:"Foundation Pour — the 2026 builder stack",days:[
 {t:"Scaffold the stack",d:["Create the repo: Next.js + TypeScript + Tailwind. Push to GitHub; connect Vercel so every push auto-deploys."],g:["BUILD"],h:"2.5 hrs",lesson:{essence:"the 2026 builder stack: Next.js, TypeScript, Tailwind, GitHub repo setup, Vercel auto-deploys, and a clean first commit",bullets:["Create the real MVP repo with the stack you will use for the product, not another practice sandbox.","Use TypeScript and Tailwind from the start so structure, types, and styling habits grow with the app.","Push to GitHub and connect Vercel so every future change has a live deployment path."]}},
 {t:"Supabase: data model",d:["Plan Mode first: design your database tables with Codex, challenge the schema, then create them in Supabase."],g:["BUILD","CODEX"],h:"2.5 hrs",lesson:{essence:"Supabase data modeling: tables, columns, relationships, RLS questions, and a schema challenged before product plumbing",bullets:["Translate the MVP user stories into tables, fields, relationships, and ownership rules.","Ask Codex to challenge the schema for missing states, privacy risks, duplicate data, and future changes.","Create the first Supabase tables only after the data contract is simple enough to explain."]}},
 {t:"Supabase: auth",d:["Wire up email login end-to-end: sign up, log in, log out, protected pages."],g:["BUILD"],h:"2.5 hrs",lesson:{essence:"Supabase Auth in the product: email sign-up, login, logout, session state, protected pages, and user-owned data boundaries",bullets:["Wire an email authentication flow and verify signed-out, sign-up, signed-in, and logout states.","Protect pages that require a user session instead of trusting the UI alone.","Connect auth identity to future data access so each user sees only their own records."]}},
 {t:"App shell + core screen (static)",d:["Build the layout: navigation, page structure, and honest empty states ('No projects yet — create your first one').","Then build the most important screen with fake hardcoded data. Get the shape right before the plumbing."],g:["BUILD"],h:"3 hrs",lesson:{essence:"the first product shell: navigation, page structure, honest empty states, and a hardcoded core screen shaped before live data",bullets:["Build the app frame first so navigation, layout, and page hierarchy feel stable.","Design empty states that tell the truth about what the user can do next.","Use fake data on the core screen to prove the product shape before adding Supabase plumbing."]}},
 {t:"Core screen (live)",d:["Wire it to real Supabase data. Demo it to one person tonight, even half-broken."],g:["BUILD"],h:"2.5 hrs",lesson:{essence:"the first live product path: replacing hardcoded content with Supabase data, handling loading states, and demoing an imperfect build",bullets:["Connect the core screen to real Supabase rows instead of fake local data.","Handle loading, empty, and failed data states so the live screen stays understandable.","Demo the half-built product to one person and capture where the live flow creates confusion."]}},
 {t:"Python: CS50P 2 — Loops",d:["Watch Lecture 2. Lists, dicts, and comprehensions are Python's superpower over C-style loops — this is where Python starts feeling like Python.","ps2: pick 2–3 problems and solve them."],g:["CS50P"],h:"2.5 hrs",l:[["CS50P",PYL]],lesson:{essence:"CS50P Lecture 2: Python loops, while, for, lists, dictionaries, iteration patterns, and concise data handling with comprehensions",bullets:["Compare Python loops with C and JavaScript loops while noticing Python's cleaner collection syntax.","Practice while loops, for loops, lists, dictionaries, and iterating over structured data.","Solve a few problem-set exercises so loops become useful for automation and data cleanup."]}},
 REST()
]},
{p:3,theme:"Build Sprint 1 — core feature #1",days:[
 {t:"Plan Mode: spec feature #1",d:["Spec the single most important feature with Codex in Plan Mode. Stay in Plan Mode all sprint for anything touching 3+ files."],g:["BUILD","CODEX"],h:"2 hrs",lesson:{essence:"feature #1 scoping: choosing the highest-value product action, writing criteria, naming risks, and planning multi-file work",bullets:["Choose the one core feature that proves the MVP can create real user value.","Use Plan Mode to define the user story, acceptance criteria, data flow, files likely touched, and risks before code changes.","Keep anything touching three or more files in reviewed planning so Derrick owns the shape of the feature."]}},
 {t:"Build",d:["Implement the happy path of feature #1."],g:["BUILD"],h:"2.5 hrs",lesson:{essence:"the first feature happy path: implementing the smallest successful user flow, connecting UI, state, and data without chasing edge cases yet",bullets:["Build the simplest path where a user starts, completes the feature, and sees the expected result.","Connect only the UI, state, data, and server pieces needed for that successful flow.","Run the feature immediately and write down what still feels confusing before expanding scope."]}},
 {t:"Build + edge cases",d:["Handle the unhappy paths: bad input, missing data, double-clicks, slow network."],g:["BUILD"],h:"2.5 hrs",lesson:{essence:"feature hardening: bad input, missing records, duplicate actions, slow responses, recovery states, and clear feedback when the happy path breaks",bullets:["List realistic failure paths for feature #1 before adding more product surface area.","Handle bad input, missing data, double-clicks, and slow network states with visible user feedback.","Test each unhappy path in the browser so the product fails clearly instead of silently."]}},
 {t:"Manual test + explain-then-rebuild",d:["Use the feature like a hostile stranger would. Fix what breaks.","Then take the trickiest function Codex drafted this week, delete it, and rebuild it yourself from scratch."],g:["BUILD","CODEX"],h:"2.5 hrs",lesson:{essence:"manual product testing and ownership: hostile-stranger use, bug capture, priority fixes, and rebuilding the hardest generated function",bullets:["Test feature #1 with impatient clicks, wrong inputs, refreshes, and unexpected paths.","Fix the most important breakages while keeping the feature small enough to reason about.","Delete and rebuild the trickiest Codex-drafted function so the implementation becomes yours."]}},
 {t:"Python: CS50P 3 — Exceptions",d:["Watch Lecture 3. try/except/raise — the same edge-case muscle you used on your product this week, different language.","ps3: 2–3 problems."],g:["CS50P"],h:"2.5 hrs",l:[["CS50P",PYL]],lesson:{essence:"CS50P Lecture 3: exceptions, try, except, else, raise, input validation, and writing Python programs that fail safely",bullets:["Use try and except to catch expected failures instead of letting Python crash without context.","Practice raise, validation loops, and clear error handling through a few problem-set exercises.","Connect Python exceptions to the same unhappy-path thinking used to harden feature #1."]}},
 {t:"Demo + journal",d:["Demo the feature to someone. Journal what you learned and what scared you."],g:["SHIP"],h:"1.5 hrs",lesson:{essence:"feature demo and founder reflection: showing core feature #1 to another person, watching reactions, recording fear, confusion, and evidence for the next sprint",bullets:["Demo the working feature to someone who can react without knowing every build decision.","Notice where they understand, hesitate, ask questions, or care less than expected.","Journal what the sprint taught, what still feels scary, and what evidence should guide feature #2."]}},
 REST()
]},
...
function outcomeFor(day, week, phase){
  ...
  if(phase===3&&day.g.includes("CS50P"))
    return "turn the Python concept into runnable examples, problem-set reps, and one reusable automation insight";
